      ...
      <main className="container mx-auto px-4 py-8">
        ...
        >
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
            <div>
              <h1 className="text-3xl font-bold text-academy-text">Welcome, {user?.name}</h1>
              <p className="text-academy-muted">Browse and book seminar halls for your events</p>
            </div>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6 mb-8">
            <div className="flex flex-col md:flex-row gap-4">
              <div className={`flex-grow relative ${isSearchFocused ? 'ring-2 ring-academy-blue rounded-md' : ''}`}>
              ...
              <div className="flex-shrink-0 flex gap-2 overflow-x-auto pb-2">
                <Button
                  ...
                  className={selectedBlock === null ? "bg-academy-blue hover:bg-academy-light-blue" : ""}
                ...
                {blocks.map(block => (
                  <Button
                    ...
                    className={selectedBlock === block ? "bg-academy-blue hover:bg-academy-light-blue" : ""}
          ...
          {filteredHalls.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-academy-muted">Try adjusting your search or filters</p>
            </div>
          ) : (
